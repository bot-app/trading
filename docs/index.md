...
<a class="github-button" href="https://github.com/bot-app/trading" data-icon="octicon-star" data-size="large" aria-label="Star bot-app/trading on GitHub">Star</a>
<a class="github-button" href="https://github.com/bot-app/trading/fork" data-icon="octicon-repo-forked" data-size="large" aria-label="Fork bot-app/trading on GitHub">Fork</a>
<a class="github-button" href="https://github.com/bot-app/trading/archive/stable.zip" data-icon="octicon-cloud-download" data-size="large" aria-label="Download bot-app/trading on GitHub">Download</a>
...
![trading screenshot](assets/trading-screenshot.png)

## Features

- Develop your Strategy: Write your strategy in python, using [pandas](https://pandas.pydata.org/). Example strategies to inspire you are available in the [strategy repository](https://github.com/bot-app/trading-strategies).
