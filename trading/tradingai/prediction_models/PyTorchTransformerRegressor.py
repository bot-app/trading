...
from trading.tradingai.base_models.BasePyTorchRegressor import BasePyTorchRegressor
from trading.tradingai.data_kitchen import FreqaiDataKitchen
from trading.tradingai.torch.PyTorchDataConvertor import (DefaultPyTorchDataConvertor,
                                                         PyTorchDataConvertor)
from trading.tradingai.torch.PyTorchModelTrainer import PyTorchTransformerTrainer
from trading.tradingai.torch.PyTorchTransformerModel import PyTorchTransformerModel
...
class PyTorchTransformerRegressor(BasePyTorchRegressor):
    ...
    parameters are passed via `model_training_parameters` under the tradingai
