...
from trading.tradingai.torch.PyTorchDataConvertor import PyTorchDataConvertor
from trading.tradingai.torch.PyTorchTrainerInterface import PyTorchTrainerInterface
...
class PyTorchModelTrainer(PyTorchTrainerInterface):
    ...
    def fit(self, data_dictionary: Dict[str, pd.DataFrame], splits: List[str]):
        ...
        optional "test" could be added by setting tradingai.data_split_parameters.test_size > 0
        in the config file.
