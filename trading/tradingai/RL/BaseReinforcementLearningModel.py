...
from trading.tradingai.RL.Base5ActionRLEnv import Actions, Base5ActionRLEnv
from trading.tradingai.RL.BaseEnvironment import BaseActions, BaseEnvironment, Positions
from trading.tradingai.tensorboard.TensorboardCallback import TensorboardCallback
...
class BaseReinforcementLearningModel(IFreqaiModel):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.max_threads = min(self.tradingai_info['rl_config'].get(
            'cpu_count', 1), max(int(self.max_system_threads / 2), 1))
        th.set_num_threads(self.max_threads)
        self.reward_params = self.tradingai_info['rl_config']['model_reward_parameters']
        ...
        self.rl_config = self.tradingai_info['rl_config']
        ...
        self.policy_type = self.tradingai_info['rl_config']['policy_type']
    ...
    def unset_outlier_removal(self):
        ...
        if self.tradingai_info['data_split_parameters'].get('shuffle', False):
            self.tradingai_info['data_split_parameters'].update({'shuffle': False})
    ...
    def train(
        ...
        if self.tradingai_info.get('data_split_parameters', {}).get('test_size', 0.1) != 0:
            (dd["test_features"],
             dd["test_labels"],
