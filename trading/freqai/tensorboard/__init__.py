...
try:
    from trading.freqai.tensorboard.tensorboard import TensorBoardCallback, TensorboardLogger
    TBLogger = TensorboardLogger
    TBCallback = TensorBoardCallback
except ModuleNotFoundError:
    from trading.freqai.tensorboard.base_tensorboard import (BaseTensorBoardCallback,
