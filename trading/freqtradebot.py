...
from trading.configuration import validate_config_consistency
from trading.constants import BuySell, Config, ExchangeConfig, LongShort
from trading.data.converter import order_book_to_dataframe
from trading.data.dataprovider import DataProvider
from trading.edge import Edge
from trading.enums import (ExitCheckTuple, ExitType, RPCMessageType, RunMode, SignalDirection,
                             State, TradingMode)
from trading.exceptions import (DependencyException, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, PricingError)
from trading.exchange import (ROUND_DOWN, ROUND_UP, timeframe_to_minutes, timeframe_to_next_date,
                                timeframe_to_seconds)
from trading.exchange.common import remove_exchange_credentials
from trading.misc import safe_value_fallback, safe_value_fallback2
from trading.mixins import LoggingMixin
from trading.persistence import Order, PairLocks, Trade, init_db
from trading.persistence.key_value_store import set_startup_time
...
from trading.rpc import RPCManager
from trading.rpc.external_message_consumer import ExternalMessageConsumer
from trading.rpc.rpc_types import (RPCBuyMsg, RPCCancelMsg, RPCProtectionMsg, RPCSellCancelMsg,
                                     RPCSellMsg)
from trading.strategy.interface import IStrategy
from trading.strategy.strategy_wrapper import strategy_safe_wrapper
from trading.util import FtPrecise
from trading.util.binance_mig import migrate_binance_futures_names
...
class TradingBot(LoggingMixin):
    ...
    def process(self) -> None:
        ...
        # Without this, trading may try to recreate stoploss_on_exchange orders
