...
from trading.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from trading.data.dataprovider import DataProvider
from trading.enums import (CandleType, ExitCheckTuple, ExitType, MarketDirection, RunMode,
                             SignalDirection, SignalTagType, SignalType, TradingMode)
from trading.exceptions import OperationalException, StrategyError
from trading.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from trading.misc import remove_entry_exit_signals
from trading.persistence import Order, PairLocks, Trade
from trading.strategy.hyper import HyperStrategyMixin
from trading.strategy.informative_decorator import (InformativeData, PopulateIndicators,
...
class IStrategy(ABC, HyperStrategyMixin):
    ...
    def adjust_entry_price(self, trade: Trade, order: Optional[Order], pair: str,
        ...
        For full documentation please go to https://bot-app.github.io/trading/en/latest/strategy-callbacks/
...
###
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by trading itself, but intended to be used if users lock pairs
