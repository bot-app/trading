...
from trading.constants import (DEFAULT_AMOUNT_RESERVE_PERCENT, NON_OPEN_EXCHANGE_STATES, BidAsk,
                                 BuySell, Config, EntryExit, ExchangeConfig,
                                 ListPairsWithTimeframes, MakerTaker, OBLiteral, PairWithTimeframe)
from trading.data.converter import clean_ohlcv_dataframe, ohlcv_to_dataframe, trades_dict_to_list
from trading.enums import OPTIMIZE_MODES, CandleType, MarginMode, TradingMode
from trading.enums.pricetype import PriceType
from trading.exceptions import (DDosProtection, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, OperationalException, PricingError,
                                  RetryableOrderError, TemporaryError)
from trading.exchange.common import (API_FETCH_ORDER_RETRY_COUNT, remove_exchange_credentials,
                                       retrier, retrier_async)
from trading.exchange.exchange_utils import (ROUND, ROUND_DOWN, ROUND_UP, CcxtModuleType,
...
from trading.exchange.types import OHLCVResponse, OrderBook, Ticker, Tickers
from trading.misc import (chunks, deep_merge_dicts, file_dump_json, file_load_json,
                            safe_value_fallback2)
from trading.plugins.pairlist.pairlist_helpers import expand_pairlist
from trading.util import dt_from_ts, dt_now
from trading.util.datetime_helpers import dt_humanize, dt_ts
...
class Exchange:
    ...
    def fetch_dry_run_order(self, order_id) -> Dict[str, Any]:
        ...
        try:
            ...
            from trading.persistence import Order
