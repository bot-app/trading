...
from trading.misc import round_coin_value
...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from trading.data.btanalysis import load_backtest_stats
    from trading.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
