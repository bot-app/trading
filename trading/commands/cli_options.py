...
from trading import __version__, constants
from trading.constants import HYPEROPT_LOSS_BUILTIN
...
AVAILABLE_CLI_OPTIONS = {
    ...
    "tradingaimodel": Arg(
        '--tradingaimodel',
        help='Specify a custom tradingaimodels.',
        metavar='NAME',
    ),
    "tradingaimodel_path": Arg(
        '--tradingaimodel-path',
        help='Specify additional lookup path for tradingaimodels.',
        metavar='PATH',
    ),
    "tradingai_backtest_live_models": Arg(
