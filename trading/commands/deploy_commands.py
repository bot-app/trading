...
from trading.configuration.directory_operations import copy_sample_files, create_userdata_dir
from trading.constants import USERPATH_STRATEGIES
from trading.enums import RunMode
from trading.exceptions import OperationalException
from trading.util import render_template, render_template_with_fallback
...
def get_ui_download_url(version: Optional[str] = None) -> Tuple[str, str]:
    base_url = 'https://api.github.com/repos/trading/frequi/'
